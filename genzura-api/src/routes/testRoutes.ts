 ...
 */
router.post('/email/connection', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/email/all-templates', async (req: Request, res: Response) => {
  try {
    const { to } = req.body;

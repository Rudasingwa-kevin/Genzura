...
export class SubscriptionController {
   ...
   */
  static async checkCaseLimit(req: Request, res: Response) {
    try {
      const userId = req.user?.id;
   ...
   */
  static async checkDocumentLimit(req: Request, res: Response) {
    try {
      const userId = req.user?.id;
  ...
  static async getFeatures(req: Request, res: Response) {
    try {
      ...
      const features = SubscriptionService.getFeaturesByPlan(plan as SubscriptionPlan);

 ...
 */
import { matchAndSaveLaws, getCaseLaws, } from '../services/lawMatchingService.js';
 ...
 */
export async function matchLawsToCaseEndpoint(req, res) {
    try {
        ...
        // Match and save laws
        const result = await matchAndSaveLaws(caseId, {
 ...
 */
export async function getCaseLawsEndpoint(req, res) {
    try {
        const { caseId } = req.params;
 ...
 */
export async function addLawToCaseEndpoint(req, res) {
    try {
        const { caseId } = req.params;
 ...
 */
export async function removeLawFromCaseEndpoint(req, res) {
    try {
 ...
 */
export async function updateCaseLawEndpoint(req, res) {
    try {
        const { caseId, lawId } = req.params;
 ...
 */
export async function searchLawsEndpoint(req, res) {
    try {
 ...
 */
export async function getLegalArticleEndpoint(req, res) {
    try {
...
//# sourceMappingURL=lawController.js.map
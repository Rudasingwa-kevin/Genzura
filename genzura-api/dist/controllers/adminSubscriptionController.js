    ...
    static async getStats(req, res) {
        try {
            ...
            const stats = users.reduce((acc, user) => {
                ...
                if (user.subscriptionEndDate) {
                    const daysUntilExpiry = Math.floor((new Date(user.subscriptionEndDate).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24));
...
//# sourceMappingURL=adminSubscriptionController.js.map